...
CONTAINS
  ...
  SUBROUTINE DetectTroubledCells_Euler( iX_B0, iX_E0, iX_B1, iX_E1, U, D )
    ...
    IF( nDimsX .EQ. 1 ) &
      CALL DetectTroubledCells_Euler_nDimsX_1( iX_B0, iX_E0, iX_B1, iX_E1, U, D )

    IF( nDimsX .EQ. 2 ) &
      CALL DetectTroubledCells_Euler_nDimsX_2( iX_B0, iX_E0, iX_B1, iX_E1, U, D )

    IF( nDimsX .EQ. 3 ) &
      CALL DetectTroubledCells_Euler_nDimsX_3( iX_B0, iX_E0, iX_B1, iX_E1, U, D )

!    CALL DetectTroubledCells_Euler_cpu( iX_B0, iX_E0, iX_B1, iX_E1, U, D )

  END SUBROUTINE DetectTroubledCells_Euler


  SUBROUTINE DetectTroubledCells_Euler_cpu( iX_B0, iX_E0, iX_B1, iX_E1, U, D )
  ...
  END SUBROUTINE DetectTroubledCells_Euler_cpu
